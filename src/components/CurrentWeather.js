            ...
            <div className='ui segments' id='current_weather'>
                <div className='ui segment' id='weather_div'>
                    ...
                    <div id="place_day" className="mb-3">
                        <span className="row mb-2"><img src={require("../images/pin.png")} alt="place"
                                                        style={{width: "1.5rem"}}/><p
                            className="mt-1 ml-2"><strong>{props.weather.location}</strong></p></span>
                        <span className='row mb-2'><img src={require("../images/calendar.png")} alt="date"
                                                        style={{width: "1.5rem"}}/><p
                    ...
                    <span className="row mb-2" id="temp"><img src={require("../images/temperature.png")}
                                                              alt="temperature"
                                                              style={{width: '3rem'}}/><h4
                ...
                <span className="row"><img src={require("../images/sunrise.png")} alt="sunrise"
                                           style={{width: '2.5rem'}}/><strong
                    className="mt-3 ml-2">
                    {new Date(props.weather.sunrise * 1000).toLocaleTimeString([], {
                        hour: '2-digit',
                        minute: '2-digit'
                    })}</strong></span>
                    <span className="row"><img src={require("../images/sunset.png")} alt="sunset"
                                               style={{width: '2.5rem'}}/><strong
                        className="mt-3 ml-2">
                ...
                <div className='ui segment' id='atmos_div'>
                    ...
                    <div id="atmos_2">
                    <span className="row"><img src={require("../images/uvi.png")} alt="uv_index"
                                               style={{width: '2rem'}}/><strong
